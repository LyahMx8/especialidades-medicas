...
public class imprimir extends javax.swing.JFrame {
    ...
    public imprimir(String nombre, String sexo, String cedula, String nacimiento) {
        initComponents();
        cargarDatos(nombre, sexo, cedula, nacimiento);
    }

    private void cargarDatos(String nombre, String sexo, String cedula, String nacimiento) {
        nomPacien.setText(nombre);
        sexPacien.setText(sexo);
        epsPacien.setText(cedula);
        areaPacien.setText(nacimiento);
        diagPacien.setText("Ficha preparada para reporte del usuario seleccionado.");

        nomPacien.setEditable(false);
        sexPacien.setEditable(false);
        epsPacien.setEditable(false);
        areaPacien.setEditable(false);

        jLabel3.setText("Herramienta de Gestion Medica");
        jLabel1.setText("Vista de ficha del usuario");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            String cedula = epsPacien.getText();
            if (cedula == null || cedula.trim().isEmpty()) {
                JOptionPane.showMessageDialog(this, "No hay cedula para exportar.", "Aviso", JOptionPane.WARNING_MESSAGE);
                return;
            }
            pdf reporte = new pdf();
            File archivo = reporte.exportarFichaUsuario(cedula.trim());
